...
class User(db.Model, UserMixin):
    ...
    gender = db.Column(db.String(32), unique=False, nullable=True) #Needed only for random pairing
    age = db.Column(db.Integer, unique=False, nullable=True) #Needed only for random pairing
